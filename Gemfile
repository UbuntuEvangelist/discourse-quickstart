...
if rails4?
  gem 'rails', '>= 4.0.0', :git => 'git://github.com/rails/rails.git', :branch => '4-0-stable'
  gem 'redis-rails', '>= 4.0.0', '>= 4.0.0', :git => 'git://github.com/SamSaffron/redis-store.git'
  gem 'rails-observers'
...
gem 'rack-cors', '>= 0.2.9', require: false
