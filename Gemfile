...
if rails4?
  ...
  gem 'rails', '5.0.0'
  gem 'strong_parameters' , '>= 0.2.1' # remove when we upgrade to Rails 4
...
gem 'rack-cache', '>= 1.2', require: false
gem 'rack-cors', '>= 0.2.7', require: false
